      ...
      ><v-row
        ><v-col>
          <div class="text-center" data-aos="zoom-in">
            <h1>CONTACT</h1>
            <p>
              For more information about the Domestic Violence Fatality Review,
              please contact
              <a href="mailto:cja.info@illinois.gov">cja.info@illinois.gov</a>.
            </p>
            <p>
              Subscribe to the
              <a
                ...
                >CJ Dispatch for the latest ICJIA and DVFR information.</a
              >
            </p>
